import {
  ...
  MapPin, Calendar, AlertTriangle, MessageSquare,
  Send, Users,
} from 'lucide-react';
        ...
        <div className="bg-surface-container-lowest border border-outline-variant rounded-2xl p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-5 p-5 border-l-4 border-primary bg-primary/5 rounded-xl">
              ...
              <span className="px-4 py-2 bg-primary/10 text-primary text-sm font-bold rounded-full shrink-0">
                TRAINING
              </span>
            </div>
            ...
            <div className="flex items-center gap-5 p-5 border-l-4 border-secondary bg-secondary/5 rounded-xl">
              ...
              <span className="px-4 py-2 bg-secondary/10 text-secondary text-sm font-bold rounded-full shrink-0">
                MATCHDAY
              </span>
            </div>
